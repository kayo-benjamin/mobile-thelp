...
public class TicketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interactionAdapter = new InteractionAdapter(interactionList);
    ...
    private void loadDummyInteractions() {
        interactionList.add(new Interaction("Support", "Hello! How can I help you today?", "10:00 AM"));
        interactionList.add(new Interaction("User", "I'm having an issue with...", "10:05 AM"));
    ...
    private void addInteraction(String author, String message) {
        ...
        interactionList.add(new Interaction(author, message, timestamp));
